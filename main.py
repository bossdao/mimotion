...
time_list = [10, 12, 14, 16, 18, 19, 20]
...
min_dict = {time_list[0]: 3000, time_list[1]: 7000, time_list[2]: 10000, time_list[3]: 14000, time_list[4]: 17000, time_list[5]: 20000, time_list[6]: 24000}
# 最大步数（例如现在设置意思是在8点（你设置的第一个时间点默认8）运行会在1500到2999中随机生成一个数提交（开启气候降低步数会乘系数K）10点3000~4999。。。以此类推，步数范围建议看懂了再改，没看懂直接默认就好）
max_dict = {time_list[0]: 6999, time_list[1]: 9999, time_list[2]: 13999, time_list[3]: 16999, time_list[4]: 19999, time_list[5]: 23999, time_list[6]: 26999}
# 设置结束
